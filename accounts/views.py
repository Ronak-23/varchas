...
class EsportsRegisterViewBGMI(CreateView):
    ...
    def create_profile(user=None, **kwargs):
        userprofile = EsportsUserProfile.objects.create(user=user, gender=kwargs['gender'], phone=kwargs['phone'],
                                                 college=kwargs['college'],
                                                 state=kwargs['state'],captain_ingame_id=kwargs['captain_character_id'] , team_member2=kwargs['Member_2_Name'], team_member3=kwargs['Member_3_Name'], team_member4=kwargs['Member_4_Name'],team_member2_ingame_id=kwargs['Member_2_character_id'], team_member3_ingame_id=kwargs['Member_3_character_id'], team_member4_ingame_id=kwargs['Member_4_character_id'], team_member2_name= kwargs['Member_2_ingame_name'], team_member3_name= kwargs['Member_3_ingame_name'], team_member4_name= kwargs['Member_4_ingame_name']
                                                 )
        userprofile.save()
...
class EsportsRegisterViewChess(CreateView):
    ...
    def create_profile(user=None, **kwargs):
        userprofile = EsportsUserProfile.objects.create(user=user, gender=kwargs['gender'], phone=kwargs['phone'],
                                                 college=kwargs['college'],
                                                 state=kwargs['state'],captain_ingame_id=kwargs['Lichess_id'], team_member2_ingame_id= ['Chesscom_id']
                                                 )
        userprofile.save()
